            ...
            <p style = {{fontWeight : '600'}} className="text-capitalize mt-2 ms-4">Danh mục</p>
                <a href="">
                    <li className="nav-item d-flex align-items-center ms-4">
                        ...
                        <h5 className="nav-link text-dark"  href="#">Nhà sách tiki</h5>
                    </li>
                </a>
                <a href="">
                    <li className="nav-item d-flex align-items-center ms-4">
                        ...
                        <h5 className="nav-link text-dark" href="#">Nhà cửa - Đời sống</h5>
                    </li>
                </a>
                <a href="">
                    <li className="nav-item d-flex align-items-center ms-4">
                        ...
                        <h5 className="nav-link text-dark" href="#">Điện thoại - Máy tính bảng</h5>
                    </li>
                </a>
                <a href="">
                    <li className="nav-item d-flex align-items-center ms-4">
                        ...
                        <h5 className="nav-link text-dark ">Đồ chơi - Mé & Bé</h5>
                    </li>
                </a>
                <a href="">
                    <li className="nav-item d-flex align-items-center ms-4">
                        ...
                        <h5 className="nav-link text-dark ">Thiết bị số - Phụ kiện số</h5>
                    </li>
                </a>
                <a href="">
                    <li className="nav-item d-flex align-items-center ms-4">
                        ...
                        <h5 className="nav-link text-dark ">Điện gia dụng</h5>
                    </li>
                </a>
                <a href="">
                    <li className="nav-item d-flex align-items-center ms-4">
                        ...
                        <h5 className="nav-link text-dark ">Làm đẹp - Sức khỏe</h5>
                    </li>
                </a>
                <a href="">
                    <li className="nav-item d-flex align-items-center ms-4">
                        ...
                        <h5 className="nav-link text-dark ">Ô tô - Xe đạp - Xe máy</h5>
                    </li>
                </a>
                <a href="">
                    <li className="nav-item d-flex align-items-center ms-4">
                        ...
                        <h5 className="nav-link text-dark ">Thời trang nữ</h5>
                    </li>
                </a>
            </ul>
        </div>
