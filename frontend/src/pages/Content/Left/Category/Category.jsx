        ...
        <div className='bg-white rounded-2 category'>
            <ul className="nav flex-column">
                ...
                <li className="nav-item d-flex align-items-center ms-4">
                    ...
                    <h5 className="nav-link text-dark">Nhà sách tiki</h5>
                </li>
                <li className="nav-item d-flex align-items-center ms-4">
                    ...
                    <h5 className="nav-link text-dark">Nhà cửa - Đời sống</h5>
                </li>
                <li className="nav-item d-flex align-items-center ms-4">
                    ...
                    <h5 className="nav-link text-dark">Điện thoại - Máy tính bảng</h5>
                </li>
