...
const Category = () => {
    return (
        <div className='bg-white category'>
            ...
            <p style = {{fontWeight : '600'}} class="text-capitalize mt-2 ms-4">Danh mục</p>
                <li class="nav-item d-flex align-items-center ms-4">
                    ...
                    <a class="nav-link text-dark"  href="#">Nhà sách tiki</a>
                </li>
                <li class="nav-item d-flex align-items-center ms-4">
                    ...
                    <a class="nav-link text-dark" href="#">Nhà cửa - Đời sống</a>
                </li>
                <li class="nav-item d-flex align-items-center ms-4">
                    ...
                    <a class="nav-link text-dark" href="#">Điện thoại - Máy tính bảng</a>
                </li>
                <li class="nav-item d-flex align-items-center ms-4">
                    ...
                    <a class="nav-link text-dark ">Đồ chơi - Mé & Bé</a>
                </li>
                <li class="nav-item d-flex align-items-center ms-4">
                    ...
                    <a class="nav-link text-dark ">Thiết bị số - Phụ kiện số</a>
                </li>
                <li class="nav-item d-flex align-items-center ms-4">
                    ...
                    <a class="nav-link text-dark ">Điện gia dụng</a>
                </li>
                <li class="nav-item d-flex align-items-center ms-4">
                    ...
                    <a class="nav-link text-dark ">Làm đẹp - Sức khỏe</a>
                </li>
                <li class="nav-item d-flex align-items-center ms-4">
                    ...
                    <a class="nav-link text-dark ">Ô tô - Xe đạp - Xe máy</a>
                </li>
                <li class="nav-item d-flex align-items-center ms-4">
                    ...
                    <a class="nav-link text-dark ">Thời trang nữ</a>
                </li>
            </ul>
        </div>
    )
